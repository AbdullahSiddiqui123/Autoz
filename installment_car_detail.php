...
include("header.php");
$pid=$_GET['pid'];
$fg_comp2="select * from tbl_installment_upload where  upload_id='$pid'";
                    ...
                    <div class="col-xl-8">
                        <div class="inventory-details">
                            <div class="product_details widget-padding bg-white rounded">
                                <span class="btn-meta bg-primary text-white">For Installment</span>
                    ...
                    <div class="col-xl-4">
                        <div class="iv_sidebar mt-5 mt-xl-0">
                            <div class="iv_sidebar_widget iv_pricing_widget widget-padding bg-secondary rounded">
                                <h3 class="mb-2 text-white">Rs <?php echo number_format($monthly_installment) ?> / Monthly Installment</h3>
                                <div class="widget_meta d-flex align-items-center">
                                    ...
                                    <span class="text-white"><i class="fa-solid fa-eye"></i>Rs : <?php echo $final_amount ?> / Final</span>
                                </div>
                            </div>
