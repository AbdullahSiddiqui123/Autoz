                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">Upload Car For Rent</h1>
                        ...
                        <div class="car_listing_form">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-btns d-flex align-items-center mt-40">
                                    <input type="submit" name="btn_add" class="btn btn-primary" value="Upload For Rent">
...
$insert="INSERT INTO `tbl_rent_upload`(user_id,user_type,car_title,car_conidtion,company_id,model_brand,transmission,fuel_type,color_code,car_detail,adv_amount,one_night_amount,full_day_amount,no_plate,reg_year,image_1,image_2,image_3) VALUES ('$userid','$usertype','$ucartitle','$ucondition','$ucompany','$carmodel','$utransmission','$fueltype','$ucolor','$cardetail','$uadvance','$onenight','$fullday','$noplat','$ryear','$image_1','$image_2','$image_3')";
