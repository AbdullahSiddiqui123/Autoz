...
{
$cid=$_GET['cid'];
$fg_comp2="select * from tbl_rent_upload where post_status='Active' AND company_id='$cid' order by upload_id desc";
}
...
$fg_comp2="select * from tbl_rent_upload where post_status='Active' AND full_day_amount between '$ustart' AND '$uend' AND car_title like '%$ukeyword%' OR car_detail like '%$ukeyword%' order by upload_id desc";
	...
	{
		$fg_comp2="select * from tbl_rent_upload where post_status='Active' AND full_day_amount between '$ustart' AND '$uend'  order by upload_id desc";
	}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">Car For Rent</h1>
