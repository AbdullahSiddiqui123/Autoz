                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">ShowRoom Register Page</h1>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-xxl-4">
                        <div class="login-form-area">
                            <h2 class="mb-5">Show Room Register Now !<br><span style="font-size:16px">For Exploring a Multiple Category Including Rent,Sell & Installment.</span></h2>
                            <form method="post"  enctype="multipart/form-data" class="login-form">
                                ...
                                <input type="file" name="cnicimage"  class="w-100 rounded" required="required">
                                     ...
                                     <div class="col-sm-6">
                                        <label class="fw-semibold text-secondary mb-2 mt-4">License No</label>
                                <input type="text" name="ulicense" placeholder="Enter your License" class="w-100 rounded" required="required" style="color:black">

                                    </div>
                                    <div class="col-sm-6">
                                <label class="fw-semibold text-secondary mb-2 mt-4">License Image</label>
                                <input type="file" name="licenseimage"  class="w-100 rounded" required="required">
                                ...
                                <p class=" mt-4">Register as Seller? <a href="seller_register.php">Sign Up</a></p>
                                 <p class="mt-4">Register as Buyer? <a href="buyer_register.php">Sign Up</a></p>
                            </form>
                        </div>
                    </div>
...
$ulicense=mysqli_real_escape_string($con,$_POST['ulicense']);


$image_1=$_FILES['cnicimage']['name'];
$image_tmp1=$_FILES['cnicimage']['tmp_name'];
 
$image_2=$_FILES['licenseimage']['name'];
$image_tmp2=$_FILES['licenseimage']['tmp_name'];

  move_uploaded_file($image_tmp1,"cnic_image/$image_1");
  move_uploaded_file($image_tmp2,"license_image/$image_2");

$fg_check="select * from tbl_showroom where user_email='$uemail'";
...
$insert="INSERT INTO tbl_showroom(user_name,user_email,user_password,cnic_no,cnic_image,license_no,license_image,address,phone_no,register_date) VALUES ('$uname','$uemail','$upass','$ucnic','$image_1','$ulicense','$image_2','$uaddress','$uphone',NOW())";
...
echo "<script>window.open('showroom_register.php','_self')</script>";
}
