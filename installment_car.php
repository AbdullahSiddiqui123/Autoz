...
{
$cid=$_GET['cid'];
$fg_comp2="select * from tbl_installment_upload where post_status='Active' AND company_id='$cid' order by upload_id desc";
}
else if(isset($_GET['ukeyword']))
{
	...
	$ustart=$_GET['ustart'];
	$uend=$_GET['uend'];
  // $fg_comp2="select * from tbl_installment_upload where post_status='Active' AND full_day_amount between '$ustart' AND '$uend' AND car_title like '%$ukeyword%' OR car_detail like '%$ukeyword%' order by upload_id desc";
	if($_GET['ukeyword'] !="")
	{
$fg_comp2="select * from tbl_installment_upload where post_status='Active' AND monthly_installment between '$ustart' AND '$uend' AND car_title like '%$ukeyword%' OR car_detail like '%$ukeyword%' order by upload_id desc";
	}
	else
	{
		$fg_comp2="select * from tbl_installment_upload where post_status='Active' AND monthly_installment between '$ustart' AND '$uend'  order by upload_id desc";
	}
...
{
	$fg_comp2="select * from tbl_installment_upload where post_status='Active' order by upload_id desc";
}
?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">Car For Installment</h1>
                    ...
                    <div class="col-xl-3">
                        <div class="iv2_sidebar bg-white rounded overflow-hidden">
                            ...
                            <div class="iv2_sidebar_widget iv2_search_widget">
                            	 <form method="get" action="rental_car.php">
                    ...
                    <div class="col-xl-9">
                        <div class="iv_listing mt-5 mt-xl-0">
                            ...
                            while($row_comp=mysqli_fetch_array($run_comp))
                            {
                               ...
                               $final_amount=$row_comp['final_amount'];
                               $monthly_installment=$row_comp['monthly_installment'];
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-4 col-md-6">
                                    <div class="filter-card-item position-relative overflow-hidden rounded bg-white">
                                        ...
                                        <div class="feature-thumb position-relative overflow-hidden">
                                           <center> <a href="installment_car_detail.php?pid=<?php echo $upload_id ?>"><img src="car_image/<?php echo $image_1 ?>" alt="car" class="img-fluid"></a>
                                           </center>
                                        </div>
                                        <div class="filter-card-content">
                                            <div class="price-btn text-end position-relative">
                                                <span class="small-btn-meta">Rs <?php echo number_format($monthly_installment) ?> / Monthly</span>
                                            </div>
                                            <a href="installment_car_detail.php?pid=<?php echo $upload_id ?>" class="mt-4 d-block">
                                            ...
                                            <a href="installment_car_detail.php?pid=<?php echo $upload_id ?>" class="btn outline-btn btn-sm d-block">View Details</a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
