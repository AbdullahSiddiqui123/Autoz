                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">Upload Car For Sale</h1>
                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="car_listing_sidebar">
                            ...
                            <p class="mb-0">Enter complete detail information of your car .</p>
                        ...
                        <div class="car_listing_form">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="listing_info_box bg-white rounded mt-40" id="price">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <div class="input-field">
                                                <label>Amount *</label>
                                                <input type="number" name="uamount" required="">
                                            </div>
                                        </div>
                                ...
                                <div class="form-btns d-flex align-items-center mt-40">
                                    <input type="submit" name="btn_add" class="btn btn-primary" value="Upload For Sale">
...
$insert="INSERT INTO `tbl_sale_upload`(user_id,user_type,car_title,car_conidtion,company_id,model_brand,transmission,fuel_type,color_code,car_detail,uamount,no_plate,reg_year,image_1,image_2,image_3) VALUES ('$userid','$usertype','$ucartitle','$ucondition','$ucompany','$carmodel','$utransmission','$fueltype','$ucolor','$cardetail','$uamount','$noplat','$ryear','$image_1','$image_2','$image_3')";
...
echo "<script>window.open('upload_sale_car.php','_self')</script>";
}
