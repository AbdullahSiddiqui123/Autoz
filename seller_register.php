                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="breadcrumb-content-wrapper text-center position-relative z-3">
                            <h1 class="text-white">Seller Register Page</h1>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-xxl-4">
                        <div class="login-form-area">
                            <h2 class="mb-5">Seller Register Now !<br><span style="font-size:16px">For Exploring a Multiple Category Including Rent,Sell & Installment.</span></h2>
...
$fg_check="select * from tbl_seller where user_email='$uemail'";
...
$insert="INSERT INTO tbl_seller(user_name,user_email,user_password,cnic_no,cnic_image,address,phone_no,register_date) VALUES ('$uname','$uemail','$upass','$ucnic','$image_1','$uaddress','$uphone',NOW())";
